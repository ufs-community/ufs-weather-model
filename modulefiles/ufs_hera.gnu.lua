...
prepend_path("MODULEPATH", "/scratch1/NCEPDEV/nems/role.epic/hpc-stack/libs/gnu-9.2_openmpi-3.1.4/modulefiles/stack")
...
hpc_mpich_ver=os.getenv("hpc_openmpi_ver") or "3.1.4"
load(pathJoin("hpc-openmpi", hpc_mpich_ver))
