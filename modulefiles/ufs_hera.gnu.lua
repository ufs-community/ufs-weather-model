...
prepend_path("MODULEPATH", "/scratch4/NCEPDEV/stmp/role.epic/installs/gnu/modulefiles")
prepend_path("MODULEPATH", "/scratch4/NCEPDEV/stmp/role.epic/installs/openmpi/modulefiles")
