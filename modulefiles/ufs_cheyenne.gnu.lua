...
gnu_ver=os.getenv("gnu_ver") or "11.2.0"
...
prepend_path("MODULEPATH", "module use /glade/work/epicufsrt/contrib/hpc-stack/gnu11.2.0/modulefiles/stack")

hpc_ver=os.getenv("hpc_ver") or "1.2.0"
load(pathJoin("hpc", hpc_ver))

hpc_gnu_ver=os.getenv("hpc_gnu_ver") or "11.2.0"
