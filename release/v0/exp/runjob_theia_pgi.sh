...
export machine=theia.${COMPILER}  #WCOSS_C, theia, etc
...
export BASE_DATA=/scratch4/BMC/gmtb/Dom.Heinzeller/NEMSfv3gfs_base_data
...
export DATA=/scratch4/BMC/gmtb/$LOGNAME/${COMPILER}/${CASE}${PSLOT}${CDATE}
if [ -d $DATA ]; then rm -rf $DATA ; fi

# directory to save output
export ROTDIR=/scratch4/BMC/gmtb/$LOGNAME/${COMPILER}/${PSLOT}/${CASE}
