...
!  subroutine field_foo(State, fldname, fldptr2d, fldptr1d, rc)
  subroutine field_foo(State, fldname, fldptr1d, rc)
!  subroutine field_foo(State, fldname, fldptr2d, rc)
  ...
  ! ----------------------------------------------
    ...
    if (fldchk(State,trim(fldname))) then
       write(*,*) 'Field ', trim(fldname), ' found'
