...
if(APP MATCHES "^(CICE_dev_cdeps2cice)")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(CICE6      ON  CACHE BOOL "Enable CICE6"               FORCE)
  set(CDEPS      ON  CACHE BOOL "Enable CDEPS"               FORCE)
  message("Configuring UFS app in CICE-DATM-DOCN mode for standalone CICE")
endif()

if(APP MATCHES "^(CICE_dev_roms)")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(ROMS       ON  CACHE BOOL "Enable ROMS"                FORCE)
  message("Configuring UFS app in ROMS-standalone mode for standalone ROMS testing")
endif()


if(APP MATCHES "^(CICE_dev_cdeps2cice2roms)")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(ROMS       ON  CACHE BOOL "Enable ROMS"                FORCE)
  set(CDEPS      ON  CACHE BOOL "Enable CDEPS"               FORCE)
  set(CICE6      ON  CACHE BOOL "Enable CICE6"               FORCE)       
  message("Configuring UFS app for ROMS-CICE-DATM coupling")
endif()

if(APP MATCHES "^(CICE_dev_atm2cice2sch)")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(SCHISM     ON  CACHE BOOL "Enable SCHISM"              FORCE)
  set(CDEPS      ON  CACHE BOOL "Enable CDEPS"               FORCE)
  set(CICE6      ON  CACHE BOOL "Enable CICE6"               FORCE)
...
if(APP MATCHES "^(CICE_dev_cdeps2roms)")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(ROMS       ON  CACHE BOOL "Enable ROMS"                FORCE)
  set(CDEPS      ON  CACHE BOOL "Enable CDEPS"               FORCE)
  message("Configuring UFS app in DATM-ROMS mode for standalone ROMS testing")
endif()

if(APP MATCHES "^(CICE_dev_datm)")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(CDEPS      ON  CACHE BOOL "Enable CDEPS"               FORCE)
  message("Configuring UFS app in DATM-DOCN mode for testing")
endif()
