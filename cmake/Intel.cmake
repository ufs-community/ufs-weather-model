...
elseif(REPRO)
    ...
    elseif(IVYBRIDGE)
        set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -march=ivybridge")
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=ivybridge")
        set(CMAKE_Fortran_FLAGS_OPT "-no-prec-div -no-prec-sqrt")
    endif()
endif()
