...
RTPWD=${RTPWD:-$DISKNM/Ratko/develop-${BL_DATE}/${RT_COMPILER^^}}

INPUTDATA_ROOT=${INPUTDATA_ROOT:-$DISKNM/Ratko/input-data-20220414}
INPUTDATA_ROOT_WW3=${INPUTDATA_ROOT}/WW3_input_data_20220624
INPUTDATA_ROOT_BMIC=${INPUTDATA_ROOT_BMIC:-$DISKNM/Ratko/BM_IC-20220207}
