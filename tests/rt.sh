...
INPUTDATA_ROOT_GOCART=/scratch1/NCEPDEV/nems/Raffaele.Montuoro/emc.nemspara/RT/GOCART/input-data-20210614
...
[
  ...
  <!ENTITY INPUTDATA_ROOT_GOCART "${INPUTDATA_ROOT_GOCART}">
...
EOF
    ...
    (
      ...
      export INPUTDATA_ROOT_GOCART=${INPUTDATA_ROOT_GOCART}
