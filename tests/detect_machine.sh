...
case $(hostname -f) in
  ...
  comet-ln1.sdsc.edu) MACHINE_ID=comet ;; ### comet
  comet-ln2.sdsc.edu) MACHINE_ID=comet ;; ### comet
  comet-ln3.sdsc.edu) MACHINE_ID=comet ;; ### comet
  comet-ln4.sdsc.edu) MACHINE_ID=comet ;; ### comet
esac
