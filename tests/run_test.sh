...
function compute_petbounds() {
  ...
  local n=0
  unset atm_petlist_bounds ocn_petlist_bounds ice_petlist_bounds wav_petlist_bounds lnd_petlist_bounds chm_petlist_bounds med_petlist_bounds aqm_petlist_bounds
